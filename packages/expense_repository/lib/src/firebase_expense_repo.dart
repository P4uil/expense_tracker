...
class FirebaseExpenseRepo implements ExpenseRepository {
  ...
  final expenseCollectioon = FirebaseFirestore.instance.collection('expenses');
  ...
  Future<List<Expense>> getExpenses() async {
    try {
      return await expenseCollectioon.get().then((value) => value.docs
