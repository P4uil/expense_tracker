...
class _AddExpenseState extends State<AddExpense> {
  TextEditingController expnenseController = TextEditingController();
  ...
  @override
  void initState() {
    datesController.text = DateFormat('dd/MM/yyyy').format(DateTime.now());
        ...
        child: Scaffold(
          ...
          body: BlocBuilder<GetCategoriesBloc, GetCategoriesState>(
            builder: (context, state) {
              if (state is GetCategoriesSuccesss) {
                return Padding(
                        ...
                        child: isLoading
                            ...
                            : TextButton(
                                onPressed: () {
                                  setState(() {
                                    expense.amount =
                                        int.parse(expnenseController.text);
                                  });
